...
• При общем анализе состояния или демонстрации возможностей ОБЯЗАТЕЛЬНО вызывай минимум **get_performance_metrics**, **analyze_hrv_trends** и **analyze_training_status**
