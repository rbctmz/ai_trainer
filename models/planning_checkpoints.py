...
def build_planning_checkpoint(goal_plan: Dict[str, Any]) -> Dict[str, Any]:
    ...
    goal_plan_snapshot = {
        ...
        "planning_mode": goal_plan.get("planning_mode"),
        "planning_intent": goal_plan.get("planning_intent"),
        "planning_focus": goal_plan.get("planning_focus"),
        "event_date": _isoformat_date(goal_plan.get("event_date")),
        "macrocycle_event_date": _isoformat_date(goal_plan.get("macrocycle_event_date")),
        "events": [dict(event) for event in goal_plan.get("events", []) or []],
        "weeks_to_race": goal_plan.get("weeks_to_race"),
        "horizon_weeks": goal_plan.get("horizon_weeks"),
        ...
        "catalog_version": goal_plan.get("catalog_version"),
        "selector_rule_version": goal_plan.get("selector_rule_version"),
        "materializer_rule_version": goal_plan.get("materializer_rule_version"),
        "brick_allocation": dict(goal_plan.get("brick_allocation", {}) or {}),
