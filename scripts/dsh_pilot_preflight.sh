...
')"; then
      ...
      echo "  ✘ не удалось извлечь метрики сессии из $SESSION_FILE: zstd/python3 вернули ошибку — оплаченные числа не собраны (результат прогона и его код возврата это не отменяет)" >&2
