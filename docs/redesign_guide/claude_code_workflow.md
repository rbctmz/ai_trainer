# Архив: Claude Code workflow guide

> Статус на 2026-06-26: исторический workflow для старой UI-модернизации.
> Он ссылается на функции и структуру, которые были вынесены из `app.py`.
> Не использовать как текущую инструкцию без нового ExecPlan.
