# Архив: руководство по редизайну интерфейса

> Статус на 2026-06-26: исторический redesign guide. Он описывает старый
> монолитный `app.py` и функции `show_*`, которых больше нет в текущей
> архитектуре. Использовать только как reference; актуальную карту docs см.
> в `docs/README.md`.
