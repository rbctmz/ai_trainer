...
> Подтверждённый текущий backlog вынесен в
> [`../technical_debt_register.md`](../technical_debt_register.md); риски ниже
> нельзя считать открытым долгом без повторной проверки текущего дерева.
