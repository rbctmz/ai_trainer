...
- Class A architecture-changing PR: **done — PR #496**, **PR #563 / issue #557**, **PR #567 / issue #565** (prospective rows above).
- Class C UI/docs PR: **done — PR #497** (prospective row above; сам пилот — пост-мержевая запись метрик).
- Routing/lead-time verdict: **routing verified across the prospective records — Class A n=3 (PR #496, PR #563, PR #567), Class C n=1 (PR #497), total n=4** (Class A прошёл полный контур трижды, третий раз в right-sized виде; Class C — fast track; P0/P1 coverage сохранился: пойманы до merge все P1 — 1 в #496, 1 в #497 (Class C-пилот) и 2 в #563; #567 закрыт без независимых P0/P1). Сокращение lead time с n=4 не доказывается; thresholds и trend остаются на Revisit Gate (5–10 prospective PR).
