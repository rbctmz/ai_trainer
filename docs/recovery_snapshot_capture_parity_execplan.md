...
Ревизия документа: v1.7 (реализация: M1 закрыт и дополнительно укреплён fail-closed диагностикой; план отревьюен раундами `4ae3f4b`/`20f9dcb`, решения владельца D4/D5/D8 применены). На M1 изменены shared Python logic и smoke-тесты; API, UI и схема пока не менялись.
