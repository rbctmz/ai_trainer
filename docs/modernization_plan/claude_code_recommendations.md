# Архив: рекомендации по HTML рендерингу в Streamlit с помощью Claude Code

> Статус на 2026-06-26: исторический документ. Команды `claude-code`,
> абсолютные пути и инструкции ниже относятся к старой UI-модернизации.
> Не выполнять как текущий план без нового ExecPlan.
